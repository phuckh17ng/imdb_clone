...
const MovieSlide = () => {
	return (
		<div className="text-white flex justify-center flex-col items-center">
			...
			<div className=" bg-zinc-700/50 rounded h-[36px] flex items-center justify-center mt-4 w-[160px]">
				<div className="text-[#5699ef] font-semibold ml-2 text-sm">Sign in to IMDb</div>
			</div>
		</div>
	);
};
